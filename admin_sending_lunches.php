...
//        $appService->saveEnterprise($arrayPP[$i]->getOneProvider());
        ...
        if( !empty($enterpriseContact)) {
            ...
            $body  = 'Bonjour,<br/><br/>';
            $body .= 'Si vous souhaitez déjeuner à la cafétéria de la SCA Ouest, il est impératif de vous inscrire via le lien suivant :<br/>';
            ...
            $body .= '- cliquez sur le salon d\'achats mentionné en objet,<br/>- et cliquez à nouveau sur l\'onglet "Choix repas" du menu.<br/>';            
            $body .= 'Sans inscription de votre part, vous n\'aurez pas la possibilité de déjeuner sur le site.<br/><br/>';
            ...
            $altBody  = "Bonjour,\n\n";
            $altBody .= "Si vous souhaitez déjeuner à la cafétéria de la SCA Ouest, il est impératif de vous inscrire via le lien suivant :\n";
            ...
            $altBody .= '- cliquez sur le salon d\'achats mentionné en objet,'."\n".'- et cliquez à nouveau sur l\'onglet "Choix repas" du menu.'."\n";
            $altBody .= "Sans inscription de votre part, vous n'aurez pas la possibilité de déjeuner sur le site.\n\n";
...
<head>
    ...
    <title>PFManagement | Info Repas</title>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Info Repas</span>
                </li>
                <li>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-9">
                    <h2><i class="fa fa-cutlery" aria-hidden="true"></i> Demande aux Fournisseurs présents + Magasins d'indiquer les jours où ils souhaitent déjeuner, sur la base du planning établi.</h2>
                    <ol class="breadcrumb">
                        <li class="active">
                            <strong>Administration/Info Repas</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-3">
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="alert alert-danger">
                                    ...
                                    Valider le formulaire aura pour effet d'envoyer un email d'information aux Fournisseurs et Magasins présents au salon d'achats. Cet email leur indiquera qu'il est nécessaire de choisir les jours où ils déjeuneront, et qui sera là.
                                </div>
