<?php
class UnavailabilitySp implements JsonSerializable {
    
    // Attributes
    private $idUnavailability;
    private $startDatetime;
    private $endDatetime;
    private $oneParticipant; // Participant
    private $onePurchasingFair; // PurchasingFair
    private $dateDeletion;
    
    // Constructor
    public function __construct($startDatetime, $endDatetime, $oneParticipant, $onePurchasingFair, $dateDeletion = "", $idUnavailability = -1) {
    ...
    public function jsonSerialize() {
        $array = [
            'idUnavailability' => $this->getIdUnavailability(), 
