...
//        $appService->saveEnterprise($arrayPP[$i]->getOneProvider());
        ...
        if( !empty($enterpriseContact)) {
            ...
            $body  = 'Bonjour,<br/><br/>';
            $body .= 'Vous pouvez saisir vos invités exceptionnels pour le salon d\'achats mentionné en objet si ce n\'est déjà fait.<br/><br/>';
            ...
            $altBody  = "Bonjour,\n\n";
            $altBody .= "Vous pouvez saisir vos invités exceptionnels pour le salon d'achats mentionné en objet si ce n'est déjà fait.\n\n";
...
<head>
    ...
    <title>PFManagement | Info Invités Exceptionnels</title>
    ...
    /* Spinner */
    .sk-spinner-rotating-plane.sk-spinner { background-color:#0b70b5; }
    </style>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Info Invités exceptionnels</span>
                </li>
                <li>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-9">
                    <h2><i class="fa fa-user-plus" aria-hidden="true"></i> Demander aux Fournisseurs Présents de saisir leurs invités exceptionnels</h2>
                    <ol class="breadcrumb">
                        <li class="active">
                            <strong>Administration/Info Invités Exceptionnels</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-3">
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="alert alert-danger">
                                    ...
                                    Les Fournisseurs doivent saisir les invités exceptionnels via leur interface (Nombre, noms, prénoms, jours souhaités).
                                </div>

                                <form class="m-t" role="form" action="#" method="POST">        
                                    
                                    <?php if(isset($_SESSION['purchasingFairConcerned']) && !empty($_SESSION['purchasingFairConcerned'])) { ?>
                                    <button type="submit" id="submitButtonProviders" name="submitButtonProviders" class="btn block full-width m-t-xl m-b-md hvr-icon-forward">Informer les Fournisseurs présents</button>
                                    <?php } else { ?>
