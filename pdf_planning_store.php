...
/*------------------------------------------------------------PRISE DE RDV---------------------------------------------------------*/
    ...
    foreach ($arrayDateBis as $key => $value) {
        ...
        if($testRdv != null){
            ...
            $content .= '
                <th style="vertical-align:middle;text-align:center;border:solid black 1px;font-size:12px; width:9%">FOURNISSEUR</th>
                <th style="vertical-align:middle;text-align:center;border:solid black 1px;font-size:12px">COMMERCIAL</th>';
            ...
            if($AllRdvStore != null){
                ...
                foreach ($ResultArray as $key => $value) {
                    ...
                    $content .= '<td style="border:solid black 1px; width:9%">'.$obj2.'</td>';
                    $content .= '<td style="border:solid black 1px">'.$obj1.'</td>';
                            ...
                            foreach ($obj0 as $key => $HeureIndispo1) {
                                foreach ($HeureIndispo1 as $key => $HeureIndispo1bis) {
                                    if($indispo === $HeureIndispo1bis){
                                        ...
                                        $ref = "1";
                                        $refter = "1";
                                        //$content .= '<td style="background-color:#8C9899;border:1px solid black;width:3.9%"></td>';
                                        $content .= '<td style="border:1px solid black;width:3.9%"></td>';
                                    }
                                }
                            }
                                ...
                                foreach ($HeureIndispo2 as $key => $HeureIndispo2bis) {
                                    ...
                                    foreach ($HeureIndispo2bis as $key => $HeureIndispo2bisbis) {
                                        if($indispo == $HeureIndispo2bisbis){
                                            ...
                                            $ref = "1";
                                            $content .= '<td style="background-color:#2CC36B;border:1px solid black;width:3.9%"></td>';
                                        }
                                    }
                                }
                            }
                            ...
                            foreach ($obj5 as $key => $HeureIndispo4) {
                                ...
                                foreach ($HeureIndispo4 as $key => $HeureIndispo4bis) {
                                    ...
                                    if($indispo == $HeureIndispo4bis[1][0] && $refter == "0"){
                                        $ref = "1";
                                        $refbis = "1";
                                        //$content .= '<td style="background-color:#EA6153;border:1px solid black;width:3.9%"></td>';
                                        $content .= '<td style="border:1px solid black;width:3.9%"></td>';
                            ...
                            foreach ($obj4 as $key => $HeureIndispo3) {
                                foreach ($HeureIndispo3 as $key => $HeureIndispo3bis) {
                                    ...
                                    if($indispo == $HeureIndispo3bis[1][0] && $refbis == "0" && $refter == "0"){
                                        $ref = "1";
                                        //$content .= '<td style="background-color:#EC5E00;border:1px solid black;width:3.9%"></td>';
                                        $content .= '<td style="border:1px solid black;width:3.9%"></td>';
