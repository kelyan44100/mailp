...
$storeContact = $appService->findOneEnterpriseContactByEnterprise($_SESSION['enterpriseConcerned']->getIdEnterprise());
?>
                    ...
                    <div class="col-lg-offset-3 col-lg-6">
                        <div class="ibox float-e-margins animated zoomIn">
                            ...
                            <div class="ibox-content">
                                ...
                                <?php } else { 
                                $selectMadame   = ($storeContact->getCivility() == 'Madame') ? 'selected=""' : '';
                                $selectMonsieur = ($storeContact->getCivility() == 'Monsieur') ? 'selected=""' : '';
                                ?>
                                <div class="row">
                                    <form class="form-inline m-t col-lg-12" role="form" action="#" method="POST">        
                                        <div class="text-justify">
                                            ...
                                            <input type="text" value="<?php echo $storeContact->getSurname(); ?>" name="surname" placeholder="Nom" maxlength="50" required="" size="20" style="color:#23a689;">
                                            <input type="text" value="<?php echo $storeContact->getName(); ?>"name="name" placeholder="Prénom" maxlength="50" required="" size="20" style="color:#23a689;">,
                                            contact du <strong><?php echo $_SESSION['enterpriseConcerned']->getOneProfile()->getName().' '.$_SESSION['enterpriseConcerned']->getName(); ?></strong>.
                                            Il est possible de m'envoyer des emails à l'adresse suivante :
                                            <input type="email" value="<?php echo $storeContact->getEmail(); ?>" name="email" placeholder="E-mail" maxlength="100" required="" size="25" style="color:#23a689;">.
                                            <br/>
                                            <div class="text-right m-t-xl m-b-xl">
                                                <em>Dernier enregistrement le <?php echo DateTime::createFromFormat('Y-m-d H:i:s', $storeContact->getRegistrationDate())->format('d/m/Y à H:i:s') ?></em>
                                            </div>
                                            <input type="hidden" name="oneEnterprise" value="<?php echo $_SESSION['enterpriseConcerned']->getIdEnterprise(); ?>">
                                        </div>
