...
<head>
    ...
    <title>PFManagement | Visualisation des erreurs</title>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Visualisation des erreurs</span>
                </li>
                <li>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-12">
                    <h2><i class="fa fa-file-text" aria-hidden="true"></i> Visualisation des erreurs</h2>
                    <ol class="breadcrumb">
                        <li class="active">
                            <strong>Administration / Visualisation des erreurs</strong>
                        </li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="ibox float-e-margins animated zoomIn">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    ...
                                    <?php
                                    $counterErrors = 0;
                                    $logFile = fopen(dirname ( __FILE__ ) . '/errors/log_errors_php.txt', 'r');
                                    if ($logFile) {
