...
$appService = AppServiceImpl::getInstance();
	...
	if( isset($_SESSION['enterpriseConcerned']) && !empty($_SESSION['enterpriseConcerned'])&& isset($_SESSION['purchasingFairConcerned']) && !empty($_SESSION['purchasingFairConcerned']) && isset($_POST['ListDateTableau'])  && !empty($_POST['ListDateTableau']) && isset($_POST['tableAllIdFournisseurs'])  && !empty($_POST['tableAllIdFournisseurs'])) {
        ...
        $arrayListDateTableau = $_POST['ListDateTableau']; //liste des id de tous les th au format : "2019-04-23 08:00:00 - 08:30:00"
        $_SESSION['arrayListDateTableau'] = $_POST['ListDateTableau'];
        ...
        foreach ($tableAllIdFournisseurs as $key => $idF) {
            ...
            $_SESSION['arrayGlobale'] = $JourSalon;

            $ResultArray[] = [$resultat, $idF[4], $idF[3], $arrayAllPriseRDVForAllDays, $arrayIndisposRelatedToRdvWithOtherProvider, $arrayIndisposRelatedToSameHourWithOtherStoreWithSp, $idF[0], $idF[1], $arraySurbrillance];
